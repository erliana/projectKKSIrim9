...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item cta mr-md2"><a href="beranda.php" class="nav-link">Home</a></li>
    ...
    <br>
    <br>
<center><h1 class="font-italic">Welcome to Jibasku</h1>
  <img src="animasi.jpg" style="width: 300px; height: 300px;">
</center>
<br>
<br>
