      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item"><a href="beranda.php" class="nav-link">Home</a></li>
...
<div class="container">
	<div class="row">
		<div class="span2"></div>
			<div class="span8">
 				<center><h3>UPDATE DATA SISWA</h3>
					<form action="update_siswa2.php" method="post">
...
$data = mysqli_query($conn,"SELECT nama, tanggal_lahir, jurusan, kelas, alamat from siswa where nama='$no'");
...
<tr>
	...
	<td width="138"><input
			name="nama" type="text" id="nama" value="<?php echo $d['nama']; ?>"
			size="20" /></td>
	<td width="138"><input
			name="nama2" type="hidden" id="nama" value="<?php echo $d['nama']; ?>"
			size="20" /></td>
</tr>
<tr>
	<td>Tanggal Lahir</td>
			<?php $date = date('Y-m-d\TH:i'); ?>
			<td><input type="datetime-local" name="tanggal_lahir" value="<?= $date ?>"></td>
		</tr>
<tr>
	<td>Kelas</td>
<td>
...
<select name='kelas'
	value="<?php echo $d['kelas']; ?>"><?php echo $d['kelas']; ?>
<option
	value="<?php echo $d['kelas']; ?>"><?php echo $d['kelas']; ?></option>
<option
	value='10'>10</option>
<option
	value='11'>11</option>
...
<select name='jurusan'
	value="<?php echo $d['jurusan']; ?>"><?php echo $d['jurusan']; ?>
<option
	value="<?php echo $d['jurusan']; ?>"><?php echo $d['jurusan']; ?></option>
<option
	value='MM'>MM</option>
<option
...
<tr>
	...
	<td width="138"><input name="alamat" type="text" id="alamat" value="<?php echo $d['alamat']; ?>" size="20" /></td>
</tr>
...
<tr>
	...
	<td width="92"><a href="data_siswa.php" button class="btn btn-success" type="button" >Batal</a></button></td>
</tr>
</table>
</center>
 </form>
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              ...
              <ul class="ftco-footer-success list-unstyled float-md-left float-lft mt-5">
