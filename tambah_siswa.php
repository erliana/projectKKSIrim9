...
<div class="span8">
	<center>	
		<h3>TAMBAH DATA SISWA</h3></center>
		<div class="container">
			<div class="row">
				<div class="col-md-6 offset-md-3">
		<form action="tambah_siswa2.php" method="post">
		<table width="319" border="0" class="table table-success">
		<tr>
			<td width="152">Nama Siswa</td>
			<td width="157"><input name="nama" type="text" id="nama" size="30" /></td>
		</tr>
		<tr>
			<td>Tanggal Lahir</td>
		...
		<tr>
			...
			<td width="157"><input name="alamat" type="text" id="alamat" size="30" /></td>
		</tr>
		<tr>
			<td width="92"><button href="data_siswa.php" class="btn btn-success" type="submit">Simpan</a></button></td>
			<td width="92"><a href="beranda.php" button class="btn btn-success" type="button">Batal</a></button></td>
		</tr>
			</table>
