      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item  cta mr-md2"><a href="data_siswa.php" class="nav-link">Data Siswa</a></li>
...
<center><h3>MANAGE DATA SISWA</h3></center>
<?php 
...
?>
<a href="tambah_siswa.php" button class="btn btn-success"
  type="button">Tambah Data</a></button>

<?php
$no=1;
$sqlCount = "select count(nama) from siswa";
...
$sql_limit = "select * from siswa order by nama limit
$mulai_dari, $limit";
...
<a href= "update_siswa.php?id=<?php echo
    $data[0];?>" class="btn btn-success" type="button">Update</a>
<a href= "hapus_siswa.php?id=<?php echo
