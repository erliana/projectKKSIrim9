      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item cta mr-md2"><a href="jadwal.php" class="nav-link">Jadwal</a></li>
...
<div class="span8">
	<center>	
		...
		<tr>
		<tr>
			<td width="92"><button href="data_jadwal.php" class="btn btn-success" type="submit">Simpan</a></button></td>
